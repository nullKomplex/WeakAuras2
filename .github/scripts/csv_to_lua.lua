...
local releases = {
  wod_beta = {
    input = "wod_beta_list.csv", -- get it from https://wow.tools/casc/listfile/download/csv/build?buildConfig=806f4fd265de05a9b328310fcc42eed0 (wod_beta build when i write that, there is no mop)
