...
globals = {
	...
	"CALENDAR_ERROR_INVITES_EXCEEDED", to this event.";
	...
	"CALENDAR_TOOLTIP_AUTOAPPROVE", otherwise, you will have to approve them manually.";
	...
	"ERR_ITEM_MAX_LIMIT_CATEGORY_EQUIPPED_EXCEEDED_IS", in the %s category";
	"ERR_ITEM_MAX_LIMIT_CATEGORY_SOCKETED_EXCEEDED_IS", in the %s category";
	"ERR_ITEM_NOT_FOUND",
	...
	"ERR_PARTY_LFG_BOOT_VOTE_REGISTERED", needed to initiate a vote.";
	...
	"FLEX_RAID_LOOT_TEXT",
	"FLEX_RAID_NEED_LESS",
	"FLEX_RAID_NEED_MORE", to start a flexible raid.";
	...
	"GUILD_CHALLENGE_TOOLTIP_PROGRESS", this week.";
	...
	"INVITATION_XREALM",
	"INVITE",
	"INVITE_CONVERSATION_INSTRUCTIONS", to invite to the conversation.";
	...
	"ITEMS",
	"ITEMSLOTTEXT",
	"ITEMS_EQUIPPED", equipped";
	"ITEMS_IN_INVENTORY", in inventory";
	"ITEMS_NOT_IN_INVENTORY", missing";
	...
	"ITEM_COOLDOWN_TOTAL",
	"ITEM_COOLDOWN_TOTAL_DAYS", Cooldown)";
	"ITEM_COOLDOWN_TOTAL_HOURS", Cooldown)";
	...
	"LFD_REWARDS",
	"LFD_REWARD_DESCRIPTION_DAILY", today:";
	"LFD_REWARD_DESCRIPTION_WEEKLY", this week:";
	"LFGUILD_DECLINED",
	"LFGUILD_TAB_BROWSE",
	...
	"MEMBER_COUNT_IN_RAID_LIST", in Raid";
	"MERCHANT",
	...
	"NEWBIE_TOOLTIP_ENCHANTSLOT", rather, it will simply return to its owner's inventory.";
	...
	"OPTION_TOOLTIP_FOLLOW_TERRAIN", if you descend, it will rotate downwards.";
	...
	"PVP_ARENA_NEED_LESS", to join this arena.";
	"PVP_ARENA_NEED_MORE", to join this arena.";
	...
	"PVP_RANK_9_1_FEMALE",
	"PVP_RANK_LEADER",
	"PVP_RATEDBG_NEED_LESS", to join a rated battleground.";
	"PVP_RATEDBG_NEED_MORE", to join a rated battleground.";
	...
	"RAF_REALM_INFO",
	"RAF_REWARD_SUPPRESSED",, but already have every possible choice. Check back again when there are new choices available!";
	"RAF_SEND_INVITATION",
	"RAF_SUMMON",
	"RAF_SUMMON_LINKED",
	...
	"SPELL_RECAST_TIME_CHARGEUP_DAYS", required";
	"SPELL_RECAST_TIME_CHARGEUP_HOURS", required";
	...
	"SPELL_TIMER",
	"SPELL_TIME_REMAINING_DAYS", remaining";
	"SPELL_TIME_REMAINING_HOURS", remaining";
	"SPELL_TIME_REMAINING_MIN", remaining";
	"SPELL_TIME_REMAINING_SEC", remaining";
	"SPELL_TOTEMS",
	"SPELL_UNKNOWN",
	...
	"TIME_DAYHOURMINUTESECOND",, %d |4hour:hours;, %d |4minute:minutes;, %d |4second:seconds;";
	"TIME_ELAPSED",
	"TIME_IN_QUEUE",
	"TIME_PLAYED_ALERT",
	"TIME_PLAYED_LEVEL",
	...
	"TUTORIAL39",
	"TUTORIAL40",
	"TUTORIAL41", however, they are worth more experience. You can tell an elite creature by the golden dragon border around its portrait.";
	"TUTORIAL42",
	"TUTORIAL43",
	"TUTORIAL44",
	"TUTORIAL45",
	...
	"VERBAL_HARASSMENT_TEXT4", this type of language is always considered harassment.";
	...
	"VOICEMACRO_19_Or_2", one for when you're angry, one for when you tear flesh, one for when you chew flesh, one for when you loot bodies, one for when you skin game, and one for when you want to kill something.";
	"VOICEMACRO_19_Or_2_FEMALE", cry uncle.";
	"VOICEMACRO_19_Or_3",
	...
	"VOICEMACRO_19_Sc_1", no maggot holes at all.";
	...
	"VOICEMACRO_20_Dw_2",
	"VOICEMACRO_20_Dw_2_FEMALE", dark and rich.";
	"VOICEMACRO_20_Dw_3",
	"VOICEMACRO_20_Dw_3_FEMALE",
	"VOICEMACRO_20_Dw_4",
	"VOICEMACRO_20_Dw_4_FEMALE",
	"VOICEMACRO_20_Dw_5", stout and bitter.";
	...
	"WHO_FRAME_TOTAL_TEMPLATE", Found";
	"WHO_LIST",
	"WHO_LIST_FORMAT",
	"WHO_LIST_GUILD_FORMAT",
	"WHO_NUM_RESULTS", total";
	"WHO_TAG_CLASS",
	"WHO_TAG_EXACT",
	"WHO_TAG_GUILD",
	"WHO_TAG_NAME",
